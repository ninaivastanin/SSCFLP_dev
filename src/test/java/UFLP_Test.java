...
public class UFLP_Test {
    ...
    private static final Logger logger = LogManager.getLogger(UFLP_Test.class);

    public UFLP_Test(String optimalSolutionsFile, int maxIterations, int kMax, int numOfExecutions, String algorithmType) {
        super();
        ...
        for (String fileName : instancesFileNames) {
            ...
            logger.info("Instance: " + fileName + ", Optimal value: " + optimalValue + ", maxIterations: " + maxIterations + ", kMax: " + kMax + ", numOfExecutions: " + numOfExecutions);
            logger.info("==========================================================================================================");
            VNSTest(instancePath, optimalValue, maxIterations, kMax, numOfExecutions, algorithmType);
        }
    }

    public void VNSTest(String instancePath, double optimalValue, int maxIterations, int kMax, int numOfExecutions, String algorithmType) {
        VNS vns;
        Solution solution;
        ...
        for (int i = 0; i < numOfExecutions; i++) {
            Problem problem = new UFLP(instancePath, optimalValue);
            ...
            Result result = new Result(problem, vns.getGap(), executionTime);
    ...
    public static void main(String[] args) {
        String[] algorithmTypes = {"RVNS", "VNS"};
        UFLP_Test test = new UFLP_Test("uncapopt.txt", 10000, 3, 10, algorithmTypes[0]);
    }
}
